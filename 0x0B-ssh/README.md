...
A project of the **ALX Software Engineering program** Students will get to learn about what is a SSH, how to create an SSH RSA key pair and how to connect to a remote host using SSH.
